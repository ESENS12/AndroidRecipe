...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean ADD_NEW_DATA(DataObject obj){
        ContentValues values = new ContentValues();
        values.put(DbOpenHelper.Entry.COL_NAME, obj.getName());
        values.put(DbOpenHelper.Entry.COL_NO, obj.getName());
        values.put(DbOpenHelper.Entry.COL_PHONE, obj.getPhone());
        return true;
    }
