...
import com.example.esens.cardviewtest.R;
...
public class SpotsDialog extends AlertDialog {
    ...
    private boolean m_bDrawProgress = true;
    ...
    private void initProgress() {
        progress = (ProgressLayout) findViewById(R.id.dmax_spots_progress);
    ...
    public void showProgress(boolean bShowProgress)
    {
        m_bDrawProgress = bShowProgress;
        if(m_bDrawProgress == false)
