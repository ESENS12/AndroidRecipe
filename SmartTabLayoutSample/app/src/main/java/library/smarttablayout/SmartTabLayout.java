 ...
 */
package library.smarttablayout;
...
public class SmartTabLayout extends HorizontalScrollView {
   ...
   *
   * @param interpolator {@link biz.fatossdk.exlib.smarttablayoutlabTestItemList.SmartTabIndicationInterpolator}
   */
  ...
  /**
   * Set the {@link ViewPager.OnPageChangeListener}. When using {@link biz.fatossdk.exlib.smarttablayoutlabTestItemList.SmartTabLayout} you are
  ...
  protected TextView createDefaultTabView(CharSequence title) {
    ...
    textView.setTextSize(TypedValue.COMPLEX_UNIT_PX,getResources().getDimensionPixelSize(R.dimen.stl_setting_textsize));
   ...
   * {@link #setCustomTabView(biz.fatossdk.exlib.smarttablayoutlabTestItemList.SmartTabLayout.TabProvider)}
   */
